About grave-feedstock
=====================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/grave-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=2962&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/grave-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `grave` can be installed with `conda`:
...
It is possible to list all of the versions of `grave` available on your platform with `conda`:
...
```
mamba search grave --channel conda-forge
```
...
mamba repoquery search grave --channel conda-forge

# List packages depending on `grave`:
mamba repoquery whoneeds grave --channel conda-forge

# List dependencies of `grave`:
mamba repoquery depends grave --channel conda-forge
```
